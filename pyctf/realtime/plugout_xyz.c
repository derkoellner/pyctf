...
/*
  gcc -O2 -I/opt/afni/bin -L/opt/afni/bin -o plugout_xyz plugout_xyz.c -lmri -lmri -lexpat -lz -lf2c -lXt -lm -lXm -Wl,--rpath=/opt/afni/bin
*/
...
int afni_io(void)
{
	...
	* Note that the shm control name (here "test_plugout")
	 ...
	 sprintf( afni_buf , "DICOM_XYZ_DELTA\n"
			     "UNDERLAY_DELTA\n"
			     "OVERLAY_DELTA\n"
			     "PONAME %s\n"
			     "IOCHAN %s" ,
